...
router.get("/getAllMedicineById", function(req, res) {
  medicineDB.getAllMedicineById(req.query.medId.toString(), function(
    err,
    result
  ) {
    console.log(result);
...
router.get("/getAllPrescriptionById", function(req, res) {
  prescriptionDB.getAllPrescriptionById(
    req.query.prescriptionId.toString(),
    function(err, result) {
      console.log(result);
...
router.get("/getAllPrescriptionByPatientId", function(req, res) {
  prescriptionDB.getAllPrescriptionByPatientId(
    req.query.patientId.toString(),
    function(err, result) {
      console.log(result);
...
router.get("/getAllPrescriptionByMedId", function(req, res) {
  prescriptionDB.getAllPrescriptionByMedId(req.query.medId.toString(), function(
    err,
    result
  ) {
    console.log(result);
...
router.get("/getAllReminderById", function(req, res) {
  reminderDB.getAllReminderById(req.query.reminderId.toString(), function(
    err,
    result
  ) {
    console.log(result);
...
router.get("/getAllReminderByPatientId", function(req, res) {
  reminderDB.getAllReminderByPatientId(req.query.patientId.toString(), function(
    err,
    result
  ) {
    console.log(result);
...
router.get("/getAllReminderByDate", function(req, res) {
  reminderDB.getAllReminderByDate(req.query.dateTake.toString(), function(
    err,
    result
  ) {
    console.log(result);
...
router.get("/updateReminderPrescriptionTaken", function(req, res) {
  reminderDB.updateReminderPrescriptionTaken(
    req.query.setAdhered.toString(),
    req.query.reminderId.toString(),
    function(err, result) {
      console.log(result);
...
router.get("/insertDataIntoReminder", function(req, res) {
  reminderDB.insertDataIntoReminder(
    req.query.dateTake.toString(),
    req.query.timeTake.toString(),
    req.query.patientId.toString(),
    req.query.prescriptionId.toString(),
    req.query.adhered.toString(),
    function(err, result) {
      console.log(result);
