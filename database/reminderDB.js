...
module.exports =
    {   //function name:function(){...}
        ...
        insertDataIntoReminder: function (dateTake, timeTake, patientId, prescriptionId, adhered, callback) {
            var query = "insert into reminder (dateTake,timeTake,patientId,prescriptionId,adhered) values (?,?,?,?,?)";
            dbcontroller.query(query, [dateTake.toString(), timeTake.toString(), parseInt(patientId), parseInt(prescriptionId), adhered.toString()], function (err, rows) {
